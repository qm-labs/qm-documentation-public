...
When executing it, the program is sent to the System on Module (SOM) inside the OPX+. The compiler, inside the SOM, is responsible for converting the QUA into low-level instructions
