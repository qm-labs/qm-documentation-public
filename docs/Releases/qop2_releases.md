...
### Download
[QOP2.6.0.tar.gz.age](https://qmpublic.s3.amazonaws.com/QOP/QOP2.6.0/1766318308-7x9itz/QOP2.6.0.tar.gz.age)

- Please follow the [QOP Installation Guide](qop_installation_guide.md).
- Required to use with [QOPA 1.5.1](qopa_releases.md#qopa-151) or higher.
...
### Download
[QOP2.5.0.tar.gz.age](https://qmpublic.s3.amazonaws.com/QOP/QOP2.5.0/1754209957-6wuxhq/QOP2.5.0.tar.gz.age)
...
### Download
[QOP2.4.4.tar.gz.age](https://qmpublic.s3.amazonaws.com/QOP/QOP2.4.4/1742888094-z7k1up/QOP2.4.4.tar.gz.age)
...
### Download
[QOP222.tar.gz.age](https://qmachines-artifacts.s3.amazonaws.com/device-updates/QOP/QOP2.2.2/QOP222.tar.gz.age)
...
### Download
[QOP220.tar.gz.age](https://qmachines-artifacts.s3.amazonaws.com/device-updates/versions/QOP220.tar.gz.age)

- Please follow the [QOP Installation Guide](qop_installation_guide.md).

### Release Notes

See the [QOP 2.2 release notes](assets/QOP_Release_Notes_V2_2.pdf).
