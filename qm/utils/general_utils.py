...
def run_until_with_timeout(
    ...
    Args:
        on_iteration_callback: A callback that returns bool that is called every loop iteration.
            If True is returned, the loop is complete and on_complete_callback is called.

        on_complete_callback: A callback that is called when the loop is completed.
            This function returns the return value of on_complete_callback

        timeout: The timeout in seconds for on_iteration_callback to return True,
